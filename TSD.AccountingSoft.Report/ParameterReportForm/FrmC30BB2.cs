...
namespace TSD.AccountingSoft.Report.ParameterReportForm
{
    ...
    /// FrmC30BB
    /// </summary>
    public partial class FrmC30BB2 : FrmXtraBaseParameter, IC30BBView, IReportView
    {
        /// <summary>
       ...
       // private List<ReportListModel> _reportList;
        ...
        public List<C30BBModel> C30BBList
        {
            ...
            set
            {
                ...
                columnsCollection.Add(new XtraColumn { ColumnName = "TotalAmount", ColumnCaption = "Số tiền", ColumnType = UnboundColumnType.Decimal, FixedColumn = FixedStyle.Left, ColumnPosition = 6, ColumnVisible = true, ColumnWith = 100, Alignment = HorzAlignment.Center });
                columnsCollection.Add(new XtraColumn { ColumnName = "TotalAmountExchange", ColumnCaption = "Số tiền quy đổi", ColumnType = UnboundColumnType.Decimal, FixedColumn = FixedStyle.None, ColumnPosition = 7, ColumnVisible = false, ColumnWith = 100, Alignment = HorzAlignment.Center });
                columnsCollection.Add(new XtraColumn { ColumnName = "Address", ColumnCaption = "Địa chỉ", FixedColumn = FixedStyle.None, ColumnVisible = false, ColumnWith = 100, ColumnPosition = 8, Alignment = HorzAlignment.Center });
                columnsCollection.Add(new XtraColumn { ColumnName = "AccountNumber", ColumnCaption = "TK nợ", FixedColumn = FixedStyle.None, ColumnPosition = 9, ColumnVisible = false, ColumnWith = 100, Alignment = HorzAlignment.Center });
                columnsCollection.Add(new XtraColumn { ColumnName = "CorrespondingAccountNumber", ColumnCaption = "TK có", ColumnPosition = 10, FixedColumn = FixedStyle.None, ColumnVisible = false, ColumnWith = 100, Alignment = HorzAlignment.Center });
                columnsCollection.Add(new XtraColumn { ColumnName = "DocumentInclude", FixedColumn = FixedStyle.None, ColumnCaption = "Chứng từ đi kèm", ColumnPosition = 11, ColumnVisible = false, ColumnWith = 150, Alignment = HorzAlignment.Center });
