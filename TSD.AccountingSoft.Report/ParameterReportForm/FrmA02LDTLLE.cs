...
{
    public partial class FrmA02LDTLLE : FrmXtraBaseParameter, ISalaryVouchersView, IEmployeesView
    {
        ...
        private void FrmA02LDTLLE_Load(object sender, System.EventArgs e)
        {
            dateTimeRangeV1.DateTimeRangeSelectedIndexEvent += cboDropDown_SelectedIndexChanged;
            _salaryVouchersPresenter.DisplayAllIsRetail("8/1/2015", true, 600);
