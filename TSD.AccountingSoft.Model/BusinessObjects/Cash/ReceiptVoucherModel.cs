/***********************************************************************
 * <copyright file="ReceiptVoucherModel.cs" company="BUCA JSC">
...
namespace TSD.AccountingSoft.Model.BusinessObjects.Cash
{
    ...
    public class ReceiptVoucherModel
    {
        ...
        /// </value>
        public List<ReceiptVoucherDetailModel> ReceiptVoucherDetails { get; set; }
        public List<ReceiptVoucherParalellDetailModel> ReceiptVoucherDetailParalells { get; set; }
    }
}
