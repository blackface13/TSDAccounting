...
namespace TSD.AccountingSoft.BusinessEntities.Business.General
{
    ...
    /// </summary>
   public class GeneralParalellDetailEntity : BusinessEntities
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneralParalellDetailEntity" /> class.
        /// </summary>
        public GeneralParalellDetailEntity()
        {
            AddRule(new ValidateId("RefDetailId"));
        }

       public GeneralParalellDetailEntity(int refDetailId, string accountNumber, string correspondingAccountNumber, string description, decimal amountOc, decimal amountExchange, string currencyCode, decimal exchangeRate, int voucherTypeId, string budgetSourceCode, string budgetItemCode,
