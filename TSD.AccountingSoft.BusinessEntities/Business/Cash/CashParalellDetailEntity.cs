...
namespace TSD.AccountingSoft.BusinessEntities.Business.Cash
{
    ...
    /// </summary>
    public class CashParalellDetailEntity : BusinessEntities
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CashParalellDetailEntity"/> class.
        /// </summary>
        public CashParalellDetailEntity()
        {
        ...
        public CashParalellDetailEntity(long cashDetailId, string accountNumber, string correspondingAccountNumber, string description, decimal amountOc, decimal amountExchange, int voucherTypeId, string budgetSourceCode, string budgetItemCode, int? accountingObjectId, int? mergerFundId, long refId)
        {
