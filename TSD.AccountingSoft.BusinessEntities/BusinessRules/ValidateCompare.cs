...
namespace TSD.AccountingSoft.BusinessEntities.BusinessRules
{
    ...
    public class ValidateCompare : BusinessRule
    {
        ...
        public override bool Validate(BusinessEntities businessEntities)
        {
            try
            {
                string propValue1 = businessEntities.GetType().GetProperty(PropertyName).GetValue(businessEntities, null).ToString();
                string propValue2 = businessEntities.GetType().GetProperty(OtherPropertyName).GetValue(businessEntities, null).ToString();
