/***********************************************************************
 * <copyright file="UserControlEmployeeContractList.cs" company="BUCA JSC">
...
{
    /// <summary>
    /// class UserControlEmployeeContractList
    /// </summary>
    public partial class UserControlEmployeeContractList : BaseListUserControl, IEmployeeLeasingsView
    {
        private readonly EmployeeLeasingsPresenter _employeeLeasingsPresenter;
        private const bool IsLeasing = true;
        ...
        public IList<EmployeeLeasingModel> EmployeeLeasings
        {
            set
            {
                ...
                {
                    ColumnName = "EmployeeLeasingCode",
                    ColumnCaption = "Mã nhân viên",
                    ColumnPosition = 1,
                    ColumnVisible = true,
                    ColumnWith = 70
                });
                ColumnsCollection.Add(new XtraColumn
                {
                    ColumnName = "EmployeeLeasingName",
                    ColumnCaption = "Họ nhân viên",
                    ColumnPosition = 2,
                    ColumnVisible = true,
                    ColumnWith = 150
                });
                ...
                ColumnsCollection.Add(new XtraColumn
                {
                    ...
                    ColumnCaption = "Ngày nhân công tác",
                    ColumnPosition = 5,
                    ColumnVisible = true,
                    ColumnWith = 100,
                ...
                {
                    ColumnName = "EndDate",
                    ColumnCaption = "Ngày hết nhiệm kỳ",
                    ColumnPosition = 6,
                    ColumnVisible = true,
                    ColumnWith = 100,
                    Alignment = HorzAlignment.Center
        ...
        {
            return new FrmXtraEmployeeContractDetail();
        }
