/***********************************************************************
 * <copyright file="FrmXtraEmployeeContractDetail.cs" company="BUCA JSC">
...
{
    /// <summary>
    /// class FrmXtraEmployeeContractDetail 
    /// </summary>
    public partial class FrmXtraEmployeeContractDetail : FrmXtraBaseCategoryDetail, IEmployeeLeasingView
    {
        ...
        /// </summary>
        public FrmXtraEmployeeContractDetail()
        {
            InitializeComponent();
        ...
        protected override void InitData()
        {
            ...
            else EmployeeLeasingCode = GetAutoNumber();
        }
        ...
        {
            get { return (decimal)spinSalaryPrice.EditValue; }
            set { spinSalaryPrice.EditValue = value; }
        }
        ...
        {
            get { return (decimal)spinInsurancePrice.EditValue; }
            set { spinInsurancePrice.EditValue = value; }
        }
        ...
        /// The uniform price.
        /// </value>
        public decimal UniformPrice
        {
            get { return (decimal)spinUniformPrice.EditValue; }
            set { spinUniformPrice.EditValue = value; }
        }
